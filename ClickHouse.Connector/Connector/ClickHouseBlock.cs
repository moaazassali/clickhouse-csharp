...
public class ClickHouseBlock : IDisposable
{
    ...
    private static ClickHouseColumn CreateColumn(ClickHouseColumnType type, nint nativeColumn)
    {
        return type switch
        {
            ...
            // ClickHouseColumnType.FixedString => new ClickHouseColumnFixedString(),
            ...
            // ClickHouseColumnType.Uuid => new ClickHouseColumnUuid(),
            // ClickHouseColumnType.IPv4 => new ClickHouseColumnIPv4(),
